...
function Contact() {
  return (
    ...
    <div className="w-56  h-64 ml-72 scale-125 mt-36 bg-slate-800 bg-opacity-90 rounded-lg justify-center items-center flex flex-col shadow duration-500 float-left border-2 border-orange-300">
    ...
    <div className="w-56 scale-125 h-64 ml-64 mt-36 bg-slate-800 bg-opacity-90 rounded-lg justify-center items-center flex flex-col shadow duration-500 float-left border-2 border-orange-300">
